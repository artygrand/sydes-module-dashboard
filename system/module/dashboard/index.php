...
class DashboardController extends Controller{
	...
	public function index(){
		...
		$exists = str_replace(array(DIR_SYS . 'widget/', '.php'), '', glob(DIR_SYS . 'widget/' . '*.php'));
	...
	public function add(){
		if (isset($this->request->get['widget']) && !preg_match("/[^a-z]+/", $this->request->get['widget']) && is_file(DIR_SYS . 'widget/' . $this->request->get['widget'] . '.php')){
			$widgets = $this->config->get('widgets');
	...
	private function loadWidget($widget){
		$file = DIR_SYS . 'widget/' . $widget . '.php';
